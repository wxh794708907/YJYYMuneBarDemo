...
-(void)itemShowWithTargetPoint:(CGPoint)targetPoint type:(MuneItemShowType)type{
    ...
    //旋转动画
    CABasicAnimation * rotationAnimation = [AnimationTool rotateAnimationWithDuration:0.1 frameValue:0 toValue: M_PI * 2.0];
    CAAnimationGroup *groupAnimation = [AnimationTool groupAnimationWithAnimations:@[scaleAnimation,keyframeAnimation,opacityAnimation,rotationAnimation] duration:0.4];
...
-(void)itemHideWithPoint:(CGPoint)point{
    //添加动画
    CABasicAnimation *scaleAnimation = [AnimationTool scaleAnimationWithDuration:0.3 frameValue:0.1 toValue:1.0];
    CABasicAnimation *opacityAnimation = [AnimationTool opacityAnimationWithDuration:0.4 frameValue:0.3 toValue:1];
    ...
    //旋转动画
    CABasicAnimation * rotationAnimation = [AnimationTool rotateAnimationWithDuration:0.4 frameValue:M_PI * 2.0 toValue:0];
